...
def show_menu():
    ...
    if user_selection != 1 and user_selection != 2 and user_selection != 3 and user_selection != 4:
...
def validate_user():
    ...
    if user_id != 1 and user_id != 2 and user_id != 3:
...
def show_account_menu():
    ...
    if account_selection != 1 and account_selection != 2 and account_selection != 3:
        print("Invalid Selection")
        sys.exit(0)
    else:
...
try:
    ...
    while main_menu_selection != 4:
        ...
        if main_menu_selection == 3:
            ...
            # inititate while loop that keeps user in account menu until exit or main menu selection
        ...
        if main_menu_selection == 4:
            print("Thank you for visiting WhatABook online library")
            rint("The program will now exit...")
            sys.exit(0)
